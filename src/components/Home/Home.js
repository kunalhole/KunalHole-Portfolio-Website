  ...
  return (
    ...
    >
      <div className=" flex flex-col  items-center justify-start overflow-hidden  space-y-5 md:items-start md:w-3/5">
        <h4 className="text-primary font-bold  text-[30px]  mb-1 md:mb-3 md:text-[35px]">
          Hello, I'm Kunal Hole
        </h4>
        <h2 className="text-primary text-[25px] font-semibold md:text-[30px]">
          <span className="text-rear">{text}</span>
          <Cursor />
        </h2>
        <div className="mt-2">
          <button className="text-white px-4 py-2 text-base  bg-transparent border border-rear rounded-lg cursor-pointer hover:text-rear md:px-6 md:py-4 md:text-lg md:font-medium">
            Resume
          </button>
        </div>
